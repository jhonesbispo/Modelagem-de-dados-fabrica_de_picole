...
CREATE TABLE IF NOT EXISTS `fabrica_picoles`.`ingredientes_picole` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_ingredientes_picole` INT NOT NULL,
  `id_picole` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ingredientes_picole_1_idx` (`id_ingredientes_picole` ASC) VISIBLE,
  INDEX `fk_indredientes_picole_2_idx` (`id_picole` ASC) VISIBLE,
  CONSTRAINT `fk_ingredientes_picole_1`
    FOREIGN KEY (`id_ingredientes_picole`)
    REFERENCES `fabrica_picoles`.`ingredientes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_indredientes_picole_2`
...
-- -----------------------------------------------------
-- Table `fabrica_picoles`.`conservantes_picole`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fabrica_picoles`.`conservantes_picole` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_conservante_picole` INT NOT NULL,
  `id_picole` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_conservantes_picole_2_idx` (`id_picole` ASC) VISIBLE,
  INDEX `fk_conservantes_picole_1_idx` (`id_conservante_picole` ASC) VISIBLE,
  CONSTRAINT `fk_conservantes_picole_1`
    FOREIGN KEY (`id_conservante_picole`)
...
CREATE TABLE IF NOT EXISTS `fabrica_picoles`.`lotes_nota_fiscal` (
  ...
  INDEX `fk_lotes_nota_fiscal_1_idx1` (`id_nota_fiscal` ASC) VISIBLE,
